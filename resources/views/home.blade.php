<x-app-layout>
    <x-section :id="'introduction'" class="justify-between">
        <div class="flex-1 lg:pt-10 pt-20">
            <h2 class="lg:text-4xl sm:text-3xl text-xl text-center">Mēs precamies!</h2>
            <h1 class="lg:text-6xl sm:text-5xl text-4xl text-center font-bold">Linards & Simona</h1>
            <h2 class="lg:text-4xl sm:text-3xl text-xl text-center">30.12.2025.</h2>
        </div>
        <div class="animate-bounce flex-2 flex justify-center">
            <a href="#rsvp">
                <x-arrow-down/>
            </a>
        </div>
    </x-section>
    <x-section :id="'rsvp'" class="bg-main-color-1 justify-center">
        <div class="flex-1 ">
